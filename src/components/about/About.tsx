...
import icon from '../../assets/img/mint_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Mint Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/MintNetwork/mint-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
